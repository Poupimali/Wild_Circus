    ...
    public function load(ObjectManager $manager)
    {
        $artists = [
            ['name' => 'Anna',
                ...
                'picture' => 'Anna-Stépanoff-350x350.jpg',
            ...
            ['name' => 'Elisa',
                ...
                'role' => 'AUGUSTE'],
            ['name' => 'Joséphine',
                'picture' => 'Joséphine-Maury-350x350.jpg',
            ...
            ['name' => 'Aurélien',
                'type' => 'Performeur',
                'picture' => 'Aurelien_Barbier-350x350.jpg',
            ...
            ['name' => 'Alexandre',
                'type' => 'Artiste',
                'picture' => 'Alexandre-Lorion-350x350.jpg',
